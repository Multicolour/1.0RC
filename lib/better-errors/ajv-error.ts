...
class AJVValidationError extends PrettyErrorWithStack {
  ...
  private getValidationErrorsFromAJVAST(): string[] {
    return this.validationErrors.reduce(
      (neatErrors: string[], currentError: ErrorObject): string[] => {
        switch (currentError.keyword) {
          ...
          case "minProperties":
            ...
            neatErrors.push(
              `Property "${this.object}${
                ...
                (currentError.params as LimitParams).limit
              }' defined properties`,
            )
            break
          case "enum":
          ...
          case "additionalProperties":
            ...
            // tslint:disable-next-line:max-line-length
            neatErrors.push(
              `Data path ${this.object}${
                currentError.dataPath
              } shouldn't have the property "${
                (currentError.params as AdditionalPropertiesParams)
                  .additionalProperty
              }". Maybe you misspelled the propery? Check your service's configuration.`,
            )
          ...
          default:
            neatErrors.push(
              "Couldn't make this message more user friendly. Here it is raw, sorry about that:",
            )
            neatErrors.push(
